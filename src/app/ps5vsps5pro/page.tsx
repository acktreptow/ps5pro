const PS5vsPS5ProPage = (): JSX.Element => {
  return (
    <div>
      <div className="container mx-auto flex-grow text-slate-800 relative">
        ...
        <div className="bg-slate-100 p-8 rounded shadow-lg mb-8">
          ...
          <div className="flex mb-8 gap-8">
            <div className="w-1/2">
              ...
              <p>
                <span className="font-semibold">GPU:</span> Custom AMD RDNA 2 |
                36 CUs up to 2.23 GHz | 10.28 TFLOPs
              </p>
              <p>
              ...
              <p>
                <span className="font-semibold">RAM:</span>16GB GDDR6 memory @
                14 Gbps
              </p>
              <p>
              ...
              <p>
                <span className="font-semibold">Dimensions:</span> H: 10.4cm /
                W: 39cm (Launch model) | H: 9.6cm / W: 35.8cm (Slim)
              </p>
              <p>
            ...
            <div className="w-1/2">
              ...
              <p>
                <span className="font-semibold">GPU:</span> Custom AMD RDNA 3 |
                60 CUs up to 2.23 GHz | 17.13 TFLOPs
              </p>
              <p>
                <span className="font-semibold">CPU:</span> Custom 8 core/16
              ...
              <p>
                <span className="font-semibold">Sound:</span> Same as PS5, but
                35% faster for improved soundscapes.
              </p>
              <p>
          ...
          <div>
            ...
            <p>
              <span className="font-semibold">GPU:</span> 66.67% extra CUs with
              a real-world improvement of around 45%
            </p>
            <p>
            ...
            <p>
              <span className="font-semibold">AI/Machine Learning:</span> 0 -
              300 TOPS is a infinite percentage increase. PSSR and 2-4x RT now
              possible.
            </p>
            <p>
            ...
            <p>
              <span className="font-semibold">Output:</span> 8K 60hz now
              possible
            </p>
            <p>
